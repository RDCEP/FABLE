...
var svg = d3.select("#biofuel").append("svg")
...
d3.csv("static/js/FABLE_Graph_Data/Consumption_of_Biofuels_Base.csv", function(error, data) {
  ...
  svg.append("g")
	  ...
	  .append("text")
				...
				.text("Consumption (MM Toe)");
});
  //draws title
	svg.append("text")
		.attr("transform", "translate(" + (width/2) + ", " + (height*-0.04) + ")")
		.attr("text-anchor", "middle")
		.text("Consumption of Biofuels");
})();
