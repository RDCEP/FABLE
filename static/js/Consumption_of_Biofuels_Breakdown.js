(function(){
	...
	var canvas = d3.select("#inspect-biofuels").append("svg")
		.attr("width", w)
		.attr("height", h)
		.append("g")
	...
	var year = document.getElementById('year-biofuels').value;
	
	//reads in CSV file
	d3.csv("static/js/FABLE_Graph_Data/Consumption_of_Biofuels_Base.csv", function(error, myData) {
