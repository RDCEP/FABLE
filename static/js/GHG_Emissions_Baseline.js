...
var svg = d3.select("#ghg").append("svg")
...
d3.csv("static/js/FABLE_Graph_Data/GHG_Emissions_Base.csv", function(error, data) {
  ...
  //draws zero line
	 var zeroLine = [{"x1":margin.left, "x2":width, "y1":(height/2)}];
