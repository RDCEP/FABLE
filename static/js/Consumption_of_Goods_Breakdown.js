(function(){
	...
	var canvas = d3.select("#inspect-goods").append("svg")
		.attr("width", w)
		.attr("height", h)
		.append("g")
	...
	var year = document.getElementById('year-goods').value;
	
	//reads in CSV file
	d3.csv("static/js/FABLE_Graph_Data/Consumption_Goods_Base.csv", function(error, myData) {
